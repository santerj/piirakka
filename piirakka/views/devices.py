...
def create_routes(context):
    ...
    return [
        ...
        Route(route_prefix + "bluetooth/all", list_bluetooth_devices, methods=[HTTPMethod.GET]),
        Route(route_prefix + "bluetooth/all_lazy", lazy_list_bluetooth_devices, methods=[HTTPMethod.GET]),
